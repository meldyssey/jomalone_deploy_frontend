        ...
        const fetchReviews = async () => {
            try {
                const response = await axios.get(
                    `${bkURL}/review/productReview?product_id=${product_id}`
                );
        ...
        <div>
            ...
            {reviews.length === 0 ? (
                ...
                reviews.map((review, index) => (
                    <div
                        key={`${review.review_no}-${index}`}
                        className={styles.reviewCnt}
                    >
                        <h2 className={styles.lineheight}>
                        ...
                        <button
                            ...
                            onClick={() => handleToggle(review.review_no)}
                        >
